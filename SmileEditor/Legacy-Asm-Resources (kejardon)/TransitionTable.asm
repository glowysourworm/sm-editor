;xkas assemblable file for the transition table for easier editing.
;This transition table is an optimized version of the original Super Metroid's transition table.
;Only one functional change exists which was originally a disrepresancy between the left and right states

;For Samus's pose (7E:0A1C), the game uses a different set of button detections,
;according to the following table (Pointers to the start of entries to use)
;Below that table are the list of all the poses and when they're normally used.
;Below the poses are the actual entries

lorom
noheader

;DO NOT TOUCH THIS TABLE FOR ANY REASON
org $919EE2
...
;			DW $0009
;	DW !End
;This is taking too long, I'll just do hex.
DW $0080,$0800,$0055
DW $0080,$0010,$0057
DW $0080,$0020,$0059
DW $0080,$0000,$004B
